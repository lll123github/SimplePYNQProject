...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../base_project.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../base_project.srcs/sources_1/bd/design_1/ipshared/6b56/hdl" \
       +incdir+"../../../../base_project.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../base_project.srcs/sources_1/bd/design_1/ipshared/6b56/hdl" \
       +incdir+"/media/linucong/TOSHIBAFORTH/Software/Xilinx/Vivado/2020.1/data/xilinx_vip/include"
}
